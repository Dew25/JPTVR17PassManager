...
eval("throw new Error(\"Module parse failed: Unexpected token (125:68)\\nYou may need an appropriate loader to handle this file type, currently no loaders are configured to process this file. See https://webpack.js.org/concepts#loaders\\n|     sessionStorage.setItem('listAccounts', JSON.stringify(listAccounts));\\n|     console.log('sessionStorage.listAccounts:'+sessionStorage.listAccounts);\\n>     select.addEventListener('change',resourcesModule.showAccoundFor(;\\n|   }\\n| }\");\n\n//# sourceURL=webpack:///./web/js/ResourcesModule.js?");
